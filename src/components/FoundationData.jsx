...
function FoundationData() {
  return (
    <div>
            <h2 className=" text-center py-5 font-bold">THE PRIMARY SCHOOL<br /> I TO IV</h2>
            <p className=" flex justify-center">THE FOUNDATION YEARS PROGRAMME (The Primary School) encourages inquiry and exploration, and develops children's competence in various skills reading, writing, listening, speaking, problem-solving, observation, measurement and use of information and communications technology.
